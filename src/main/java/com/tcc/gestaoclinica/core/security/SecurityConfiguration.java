...
public class SecurityConfiguration {
    ...
    public static final String [] ENDPOINTS_WITH_AUTHENTICATION_REQUIRED = {
            ...
            "/group-medical-care/**/remove-patient/**",
    };
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity.csrf().disable() // Desativa a proteção contra CSRF
                ...
                .requestMatchers(ENDPOINTS_ADMIN).hasRole("ADMNISTRADOR") // Repare que não é necessário colocar "ROLE" antes do nome, como fizemos na definição das roles
                .requestMatchers(ENDPOINTS_CUSTOMER).hasRole("ATENDENTE")
                .anyRequest().denyAll()
